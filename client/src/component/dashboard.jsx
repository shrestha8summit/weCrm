...
const Dashboard = ({ onLogout }) => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h7v7H3V3zM14 3h7v7h-7V3zM14 14h7v7h-7v-7zM3 14h7v7H3v-7z" />
                    ...
                    <span className="mt-2 block text-sm font-medium text-gray-900">Dashboard</span>
                  </button>

                  <button onClick={addLeads} className="cursor-pointer p-3 border border-gray-300 rounded-md text-center hover:bg-gray-50 transition-colors">
                   <svg className="mx-auto h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
</svg>
                    <span className="mt-2 block text-sm font-medium text-gray-900">Add Leads</span>
                  </button>
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor" stroke="none" />
                    ...
                    <span className="mt-2 block text-sm font-medium text-gray-900">Real Time Tracking</span>
                  </button>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 9v2m0 4h.01" />
                    ...
                    <span className="mt-2 block text-sm font-medium text-gray-900">Alerts And Reminder</span>
                  </button>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 12h.01" />
                    ...
                    <span className="mt-2 block text-sm font-medium text-gray-900">Phone Tracking And Analysis</span>
                  </button>
