...
const EditUser = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto my-8 flex flex-col gap-4 p-6 bg-white shadow-lg rounded-lg">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="statusOfWork">
          Status
        </label>
        <input
          id="statusOfWork"
      ...
      {/* Assigned Work */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="assignedWork">
      ...
      <button
        ...
        disabled={saving || deleting}
        className="bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-md transition duration-200 mt-2"
      >
